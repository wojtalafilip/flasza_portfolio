...
function DesktopNav() {
  return (
    <div className="flex w-3/6 flex-auto items-center justify-between font-semibold tracking-wide sm:hidden md:hidden">
      <NavLink pagePath={"/paintings"}>OBRAZY</NavLink>
      <NavLink pagePath={"/exhibitions"}>WYSTAWY</NavLink>
      <NavLink pagePath={"/bio"}>BIO</NavLink>
      <NavLink pagePath={"/contact"}>KONTAKT</NavLink>
      <div className="flex h-8 w-8  items-center justify-center rounded-full bg-cobalt p-[6px]">
        <Link
