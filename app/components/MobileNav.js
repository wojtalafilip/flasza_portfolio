...
function MobileNav() {
  return (
    <div className="flex flex-col gap-2 pb-8 font-semibold tracking-wide sm:text-lg lg:hidden">
      ...
      <div className="mt-4 flex h-8  w-8 items-center justify-center rounded-full bg-cobalt">
        <Link
